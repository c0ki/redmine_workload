...
class ListUserTest < ActiveSupport::TestCase
  ...
  def defineSaturdaySundayAndWendnesdayAsHoliday
    Setting['plugin_redmine_workloadholiday']['general_workday_monday'] = 'checked';
    Setting['plugin_redmine_workloadholiday']['general_workday_tuesday'] = 'checked';
    Setting['plugin_redmine_workloadholiday']['general_workday_wednesday'] = '';
    Setting['plugin_redmine_workloadholiday']['general_workday_thursday'] = 'checked';
    Setting['plugin_redmine_workloadholiday']['general_workday_friday'] = 'checked';
    Setting['plugin_redmine_workloadholiday']['general_workday_saturday'] = '';
    Setting['plugin_redmine_workloadholiday']['general_workday_sunday'] = '';
  end
  ...
  test "getLoadClassForHours returns \"none\" for workloads below threshold for low workload" do
    Setting['plugin_redmine_workloadholiday']['threshold_lowload_min'] = 0.1
    Setting['plugin_redmine_workloadholiday']['threshold_normalload_min'] = 5.0
    Setting['plugin_redmine_workloadholiday']['threshold_highload_min'] = 7.0
  ...
  test "getLoadClassForHours returns \"normal\" for workloads between thresholds for normal and high workload" do
    Setting['plugin_redmine_workloadholiday']['threshold_lowload_min'] = 0.1
    Setting['plugin_redmine_workloadholiday']['threshold_normalload_min'] = 2.0
    Setting['plugin_redmine_workloadholiday']['threshold_highload_min'] = 7.0
