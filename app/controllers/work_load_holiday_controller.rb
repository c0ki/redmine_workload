# -*- encoding : utf-8 -*-
class WorkLoadHolidayController < ApplicationController
  ...
  def show
    ...
    @workloadData   = ListUser::getHoursPerUserIssueAndDay(@usersToDisplay, @issuesForWorkload, @timeSpanToDisplay, @today)
  end
